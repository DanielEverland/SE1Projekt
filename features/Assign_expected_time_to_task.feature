...
And the project with title "default_test_project" contains a task with name "test task", description "test description", start date "01/01/2000" and end date "01/01/2001"
