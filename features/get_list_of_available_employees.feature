...
Scenario: Request a list of available employees from an employee with no activities
...
Scenario: Request available employees from an employee with non-overlapping tasks
	...
	And the employee is signed in
	And A task with title "Task1", description "test", start date "01/01/2020" and end date "05/01/2020" exists
    And the task is assigned to the employee
	And A task with title "Task2", description "test", start date "06/01/2020" and end date "10/01/2020" exists
    And the task is assigned to the employee
...
Scenario: Request available employees from an employee with overlapping tasks
	Given an employee with id "test" and maxTasks 2 exists in the application
	And the employee is signed in
	And A task with title "Task1", description "test", start date "01/01/2020" and end date "06/01/2020" exists
    And the task is assigned to the employee
	And A task with title "Task2", description "test", start date "05/01/2020" and end date "10/01/2020" exists
    And the task is assigned to the employee
	When a list of available employees is requested from date "01/01/2020" to date "10/01/2020"
...
Scenario: Request available employees from an employee with tasks overlapping outside the requested interval
	...
	And A task with title "Task2", description "test", start date "05/01/2020" and end date "10/01/2020" exists
    And the task is assigned to the employee
	And A task with title "Task2", description "test", start date "15/01/2020" and end date "30/01/2020" exists
    And the task is assigned to the employee
