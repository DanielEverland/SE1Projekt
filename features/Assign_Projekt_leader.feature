...
Given The project with ID 0 and title "default_test_project" exists
And an employee with id "test" exists in the application
When The employee "default_test_employee" enters the ID of employee "default_test_employee2" who shall be the project manager of the project with ID 0 and title "default_test_project"
Then The employee with ID "default_test_employee2" is now the project manager
