...
/**
 * A test class to check which tests are run with which framework. If run as a
 * JUnit 5 (Jupiter) test, then both tests are run. If run as a JUnit 4 test,
 * then only the JUnit 4 tests are run.
 */
