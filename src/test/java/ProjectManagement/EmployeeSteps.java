...
public class EmployeeSteps {
	...
	public void theEmployeeHasAnExistingTaskWithTitleDescriptionStartDateAndEndDate(String title, String description, String startDateString, String endDateString) {		
