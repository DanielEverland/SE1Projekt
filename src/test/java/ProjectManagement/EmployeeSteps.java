...
public class EmployeeSteps {
	...
	public void theEmployeeHasAnExistingTaskWithTitleDescriptionStartDateAndEndDate(String title, String description, String startDate, String endDate) {		
		holder.project.createTask(new TaskConstructorInfo(title, description, Date.FromString(startDate), Date.FromString(endDate)));
		holder.project.assignTaskToEmployee(holder.employee, holder.project.findTask(title, description, Date.FromString(startDate), Date.FromString(endDate)));
