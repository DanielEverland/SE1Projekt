...
public class EventSteps {
    ...
    public void course_with_description_from_to_is_assigned_to_the_employee(String description, String startDate, String endDate) {
    ...
    public void the_employee_has_sick_leave_from_to(String startDate, String endDate) {
        ...
        for (Activity activity : holder.employee.getEvents()) {
            if (activity instanceof SickLeave && activity.getStartDate().equals(Date.FromString(startDate)) && activity.getEndDate().equals(Date.FromString(endDate))) {
                hasSickLeave = true;
            }
        }
    ...
    public void the_employee_has_a_course_with_description_from_to(String description, String startDate, String endDate) {
        boolean hasCourse = false;
        for (Activity activity : holder.employee.getEvents()) {
            if (activity instanceof Course && ((Course)activity).getDescription().equals(description) && activity.getStartDate().equals(Date.FromString(startDate)) && activity.getEndDate().equals(Date.FromString(endDate))) {
                hasCourse = true;
            }
        }
    ...
    public void the_employee_is_not_unavailable_from_to(String startDate, String endDate) {
        assertThat(holder.employee.isAvailable(Date.FromString(startDate), Date.FromString(endDate)), is(equalTo(true)));
    }
}
